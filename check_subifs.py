...
run("show config interfaces ge800-0/0/10.1", 5)
run("show config interfaces ge800-0/0/31.1", 5)
run("show interfaces ge800-0/0/10.1 brief", 5)
run("show interfaces ge800-0/0/31 brief", 5)
